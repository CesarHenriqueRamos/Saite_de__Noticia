  ...
  <body>
      ...
      <nav class="navbar navbar-default">
        <div class="container">
          ...
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="{$HOME}">Noticias.com</a>
          </div>

          <!-- Collect the nav links, forms, and other content for toggling -->
          <div class="collapse navbar-collapse" id="identificacaoMenu">
            <ul class="nav navbar-nav">
              <li ><a href="{$PAG_CONTATO}">Contato <span class="sr-only">(current)</span></a></li>
    ...
    <main>
      ...
      <div class="container">
        ...
        <div class="col-xs-12 col-sm-12 col-md-3">
              ...
              <form class="navbar-form navbar-right" role="search" method="POST" action="">              <input type="text" name="txt_buscar" class="form-control" placeholder="Digite para buscar" required>                            
    ...
    <footer>
      <div class="container text-center">
        <p class="text-muted">Direitos reservados de Cesar Henrique Ramos</p>
      </div>
    </footer>
