...
<html>
    <head>
        ...
        <link rel="icon" href="{$GET_TEMA}/images/logo_topo.png">
...
<section class="row">
    ...
    <div class="text-center">
        ...
        <a href="{$PAG_ADM_NOTICIAS}" class="btn btn-success"><i class="glyphicon glyphicon-barcode"></i> Noticias</a>
        ...
        <a href="{$PAG_LOGOFF}" class="btn btn-danger"><i class="glyphicon glyphicon-log-out"></i> Sair </a>
            ...
            <div class="row" id="rodape">
                <center>
                    <h4>{$TITULO_SITE}</h4>
                    <P>Todos os Direitos Reservados - {$NOME} - {$GET_NOME} - Data Atual: {$DATA}</P>
                </center>
